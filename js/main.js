...
$(function() {
    ...
    // ENCABEZADO LETTERING
    $('.nombre-sitio').lettering();

    // TRACK DEL SCROLL
    // MENU FIJO
    var windowHeight = $(window).height(); // sirve para saber el ALTO de la PÁGINA WEB VISIBLE
    ...
    $(window).scroll(function() { // esto va a escuchar el scroll en la ventana
        ...
        if( scroll > windowHeight) {
            ...
            $('.barra').addClass('fixed'); // esta clase aun no la creamos pero hay que probar que se crea en el DOM correctamente
    ...
    $('.menu-movil').on('click', function() {
        $('.navegacion-principal').slideToggle(); // esto reemplaza slideDOwn y slideTOp!!!!
    ...
    // CUENTA REGRESIVA
    // primer parámetro: fecha a partir de la que el contador comenzará a contar hacia atras
    $('.cuenta-regresiva').countdown('2021/01/01 09:00:00', function(event) {
